...
List<MuseumModel> getMuseum() {
  ...
  museumModel.imgHeader = "museum-bri.jpg";
  ...
  museumModel.provinsi = "Jawa Tengah";
  museumModel.imgHeader = "museum-bpk.jpg";
  ...
  museumModel.nama = "Museum Isdiman";
  museumModel.kota = "Semarang";
  museumModel.provinsi = "Jawa Tengah";
  museumModel.imgHeader = "museum-isdiman.jpg";
  museumModel.deskripsi = "Museum Isdiman memiliki koleksi lengkap pakaian TKR dan tentara Belanda, lukisan teknik supit urang, senjata-senjata, dan  juga memajang beberapa foto wajah hitam-putih beberapa orang tentara Indonesia yang memiliki peran penting dalam pertempuran Ambarawa. Selain itu juga terdapat Monumen Palagan Ambarawa yang didirikan untuk mengenang pertempuran Palagan di Ambarawa di masa awal kemerdekaan Republik Indonesia.";
  museumModel.alamat = "Jl. Mgr. Sugiyopranoto, Panjang Lor, Ambarawa, Semarang, Jawa Tengah";
  museumModel.htm = "7500";
  museumModel.persyaratan = [];
  museumModel.noTelepon = "(024) 6921424";
  museumModel.email = "";
  museumModel.website = "";
  museum.add(museumModel);
  museumModel = new MuseumModel();
  ...
  museumModel.persyaratan = [];
  museumModel.noTelepon = "0271-642016";
  museumModel.email = "puromangkunegaran@gmail.com";
  museumModel.website = "https://puromangkunegaran.com/museum/";
  museum.add(museumModel);
  museumModel = new MuseumModel();
